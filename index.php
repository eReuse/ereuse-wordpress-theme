...
<section> <!-- presentation web -->
    ...
    <article class="well">
        <h2 id="second-slogan" class="container text-center">
            The Electronic Reuse mission is empower and engage people around the world to maximize reuse while ensuring final recycling
        </h2>
    </article>
    <article class="container" id="what-we-do">
        <header class="text-center">
            <h2>We collectively develop open resources to optimize refurbishment, enable traceability of chain of custody, ensure final recycling and social impact generated by reuse:</h2>
        </header>
