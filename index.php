...
<section> <!-- presentation web -->
    ...
    <article class="well">
        <h2 id="second-slogan" class="container text-center">
            Our goal is to extend the lifetime of electronic products through repair, refurbish, and reuse to ensure
            final recycling
        </h2>
    </article>
    ...
    <article class="well" id="community">
        ...
        <div class="container">
            <p>
                ...
                companies, public
                administration, university service-learning programs, donation programs to charities, and IT companies.
            </p>
            <div class="row text-center">
    ...
    <article class="container">
        ...
        <p>
            We recommend you reading our paper (which received a <a href="http://goo.gl/MGld0u">best paper award</a> at
            Enviroinfo 2015)
            <a href="http://goo.gl/LCibE8"><em>Breaking Barriers on Reuse of Digital Devices Ensuring Final
                    Recycling</em></a>
